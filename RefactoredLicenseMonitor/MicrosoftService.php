...
class MicrosoftApi {
    ...
    public function connect() {
        // Code to connect to Microsoft API using $this->apiEndpoint
        echo "Connected to Microsoft API at " . $this->apiEndpoint;
    }

    public function getLicenseCount() {
        // Code to fetch license count from Microsoft API
